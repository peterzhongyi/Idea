    ...
    private void Start()
    {
        ...
        for (int x = 0; x < LevelGrid.Instance.GetWidth(); x++)
        {
            for (int z = 0; z < LevelGrid.Instance.GetHeight(); z++)
            {
                ...
                Transform gridSystemVisualSingleTransform = Instantiate(gridSystemVisualSinglePrefab, LevelGrid.Instance.GetWorldPosition(gridPostion), Quaternion.identity);
    ...
    private void UpdateGridVisual()
    {
        ...
        switch (selectedAction)
        {
            ...
            case ShootAction shootAction:
                ...
                ShowGridPositionRange(selectedUnit.GetGridPosition(), shootAction.GetMaxShootDistane(), GridVisualType.RedSoft);
                break;
